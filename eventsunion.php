  ...
  $.ajax({
    ...
    success: function(response) {
      if (response.status == true) {
        ...
        $('#event_entry_modal .modal-body').append('<div class="alert alert-success" role="alert">' + response.msg + '</div>');
        ...
        $('#event_entry_modal .modal-body').append('<div class="alert alert-danger" role="alert">' + response.msg + '</div>');
      }
    },
    error: function (xhr, status) {
      console.log('ajax error = ' + xhr.statusText);
      $('#event_entry_modal .modal-body').append('<div class="alert alert-danger" role="alert">An error occurred. Please try again.</div>');
    }
  });    
  return false;
}
